...
const storageKind =
  (process.env.NEXT_PUBLIC_KEYSTATIC_STORAGE_KIND as "local" | "github") ||
  "local";
    ...
    storageKind === "github"
      ? {
          ...
          repo: {
            ...
            owner: process.env.NEXT_PUBLIC_KEYSTATIC_GITHUB_REPO_OWNER || "tu-usuario",
            name: process.env.NEXT_PUBLIC_KEYSTATIC_GITHUB_REPO_NAME || "tu-repo",
          },
        }
      : { kind: "local" },
  ui: {
